...
import 'package:ticketbooking/pages/user/passengerlistafter.dart';
      ...
      if (doc.exists) {
        ...
        try {
          ...
          try {
            ...
            try {
              parsedDate = DateFormat('M/d/yyyy').parseLoose(cleanDate);
            } catch (__) {
              try {
                parsedDate = DateFormat('d/M/yyyy').parseLoose(cleanDate);
              } catch (___) {
                try {
                  parsedDate = DateFormat('yyyy-MM-dd').parse(cleanDate);
                } catch (____) {
                  parsedDate = DateFormat('yyyy/MM/dd').parse(cleanDate);
                }
              }
