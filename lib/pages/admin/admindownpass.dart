...
class admindownpasslist extends StatefulWidget {
  const admindownpasslist({super.key});

  @override
  State<admindownpasslist> createState() => admindownpasslistState();
}

class admindownpasslistState extends State<admindownpasslist> {
  List<Pass> passenger = [];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Passengerlist"),
        backgroundColor: C.theamecolor,
      ),
      body: FutureBuilder(
        future: getpassengerlist(downbookingState.orderid!),
