...
import 'package:ticketbooking/pages/admin/upbooking.dart';

import 'package:ticketbooking/utils/urlpage.dart';

class adminpassengerlist extends StatefulWidget {
  const adminpassengerlist({super.key});

  @override
  State<adminpassengerlist> createState() => adminpassengerlistState();
}

class adminpassengerlistState extends State<adminpassengerlist> {
  List<Pass> passenger = [];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Passengerlist", style: TextStyle(color: C.textfromcolor)),
        backgroundColor: C.theamecolor,
      ),
      body: FutureBuilder(
        future: getpassengerlist(upbookingState.orderid!),
  ...
  Future getpassengerlist(String orderid) async {
    ...
    try {
      var response = await http.post(
        Uri.parse("${MyUrl.fullurl}get_passenger.php"),
        body: data,
      );
